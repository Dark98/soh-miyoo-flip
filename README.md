...
## Installation
1. [Download this Repo](https://github.com/Dark98/soh-miyoo-flip/archive/refs/heads/main.zip) and move the `soh` folder into the `App` folder on your Flip's SD Card.
...
## Updating
[Download this Repo](https://github.com/Dark98/soh-miyoo-flip/archive/refs/heads/main.zip) and move the `soh` folder into the `App` folder on your Flip's SD Card Replacing all files when asked, then delete the old `oot.otr` and/or `oot-mq.otr` files from `App/soh`. You can then follow the Installation section above skipping step 1.
